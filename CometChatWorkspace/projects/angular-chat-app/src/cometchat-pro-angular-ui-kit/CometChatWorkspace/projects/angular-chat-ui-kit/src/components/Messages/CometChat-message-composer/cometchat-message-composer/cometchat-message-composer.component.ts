...
export class CometChatMessageComposerComponent implements OnInit, OnChanges {
  ...
  actionHandler(action) {
    try {
      ...
      console.log("composer component" + message[0].data.text)
  ...
  sendTextMessage(textMsg: String = "") {
    ...
    var entitySender = {
      ...
      name: this.localStorageService.get("name"),
      role: this.localStorageService.get("role"),
      avatar: "",
      status: this.localStorageService.get("status"),
      lastActiveAt: 1636249521,
      conversationId: ""
    }
   ...
   var sender = {
    ...
    //this.messageService.saveMessageLtn(messageltn).subscribe(message => {})
